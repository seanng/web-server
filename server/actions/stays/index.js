...
const postStay = (res, rej, req, params) => {
...
module.exports = (req, params) => new Promise((res, rej) => {
  if (req.method === 'POST') return postStay(res, rej, req, params);
  if (req.method === 'GET') return getStay(res, rej, req, params);
  if (req.method === 'PUT') return putStay(res, rej, req, params);
})